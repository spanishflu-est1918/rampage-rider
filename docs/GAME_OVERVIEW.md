...
- **Heat System (0-100%):**
    - Increases with kills. Decays over time.
    - Determines **QUANTITY** of police spawns.
- **Wanted Level (0-2 Stars):**
    - Increases with *Cop* kills.
...
|--------|-------------|---------|
| **Move/Steer** | `WASD` or Arrow Keys | Camera-relative movement |
| **Sprint** | `SHIFT` (Hold) | On foot only |
...
- [ ] Combo scaling for motorbike blast
- [ ] Explicit "rampage mode" at high combo
